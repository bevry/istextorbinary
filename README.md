...
``` typescript
import * as pkg from 'https://unpkg.com/istextorbinary@^9.3.0/edition-deno/index.ts'
```
...
``` html
<script type="module">
    import * as pkg from '//cdn.skypack.dev/istextorbinary@^9.3.0'
</script>
```
...
``` html
<script type="module">
    import * as pkg from '//unpkg.com/istextorbinary@^9.3.0'
</script>
```
...
``` html
<script type="module">
    import * as pkg from '//dev.jspm.io/istextorbinary@9.3.0'
</script>
```
