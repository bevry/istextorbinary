...
``` html
<script type="module">
    import * as pkg from '//cdn.pika.dev/istextorbinary/^5.3.0'
</script>
```
...
``` html
<script type="module">
    import * as pkg from '//unpkg.com/istextorbinary@^5.3.0'
</script>
```
...
``` html
<script type="module">
    import * as pkg from '//dev.jspm.io/istextorbinary@5.3.0'
</script>
```
