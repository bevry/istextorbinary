...
``` html
<script type="module">
    import * as pkg from '//cdn.skypack.dev/istextorbinary@^8.2.0'
</script>
```
...
``` html
<script type="module">
    import * as pkg from '//unpkg.com/istextorbinary@^8.2.0'
</script>
```
...
``` html
<script type="module">
    import * as pkg from '//dev.jspm.io/istextorbinary@8.2.0'
</script>
```
