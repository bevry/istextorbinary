...
``` typescript
import * as pkg from 'https://unpkg.com/istextorbinary@^9.4.0/edition-deno/index.ts'
```
### [Skypack](https://www.skypack.dev "Skypack is a JavaScript Delivery Network for modern web apps")

``` html
<script type="module">
    import * as pkg from '//cdn.skypack.dev/istextorbinary@^9.4.0'
</script>
```
...
``` html
<script type="module">
    import * as pkg from '//unpkg.com/istextorbinary@^9.4.0'
</script>
```
...
``` html
<script type="module">
    import * as pkg from '//dev.jspm.io/istextorbinary@9.4.0'
</script>
```
...
-   [Michael Duane Mooring](https://github.com/mikeumus) — We are the space generation; and if you don't know, https://www.spaceforce.mil https://www.virgingalactic.com https://www.spacex.com now you know.
